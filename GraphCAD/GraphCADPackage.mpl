GraphCAD := module()
	description "A collection of tools for producing 2D CAD graphs, using either QuantifierElimination or RegularChains to produce the CAD.";
	option package;
	export
		PolyFactors,
		PrepPolys,
...
# I can now just directly get the 2D CAD polys in either style.
...
# Need RCCAD output=rootof instead of Info due to differences.
